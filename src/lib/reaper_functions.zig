...
/// ClearAllRecArmed
pub fn ClearAllRecArmed() void {
    return fnPtrs.ClearAllRecArmed();
}

/// ClearConsole
/// Clear the ReaScript console. See ShowConsoleMsg
pub fn ClearConsole() void {
    return fnPtrs.ClearConsole();
}

/// ClearPeakCache
/// resets the global peak caches
pub fn ClearPeakCache() void {
    return fnPtrs.ClearPeakCache();
}
...
pub fn CreateMIDIInput(dev: c_int) ?midi_Input {
...
pub fn CreateMIDIOutput(dev: c_int, streamMode: bool, msoffset100: ?*c_int) ?midi_Output {
...
pub fn CreateNewMIDIItemInProj(track: ?MediaTrack, starttime: f64, endtime: f64, qnInOptional: ?*const bool) ?MediaItem {
...
pub fn CreateTakeAudioAccessor(take: ?MediaItem_Take) ?AudioAccessor {
...
pub fn CreateTrackAudioAccessor(track: ?MediaTrack) ?AudioAccessor {
...
/// CSurf_GoEnd
pub fn CSurf_GoEnd() void {
    return fnPtrs.CSurf_GoEnd();
}

/// CSurf_GoStart
pub fn CSurf_GoStart() void {
    return fnPtrs.CSurf_GoStart();
}
...
/// CSurf_OnPause
pub fn CSurf_OnPause() void {
    return fnPtrs.CSurf_OnPause();
}

/// CSurf_OnPlay
pub fn CSurf_OnPlay() void {
    return fnPtrs.CSurf_OnPlay();
}
...
/// CSurf_OnRecord
pub fn CSurf_OnRecord() void {
    return fnPtrs.CSurf_OnRecord();
}
...
/// CSurf_OnStop
pub fn CSurf_OnStop() void {
    return fnPtrs.CSurf_OnStop();
}
...
pub fn CSurf_ResetAllCachedVolPanStates() void {
    return fnPtrs.CSurf_ResetAllCachedVolPanStates();
}
...
pub fn CSurf_SetTrackListChange() void {
    return fnPtrs.CSurf_SetTrackListChange();
}

/// CSurf_TrackFromID
pub fn CSurf_TrackFromID(idx: c_int, mcpView: bool) ?MediaTrack {
...
/// DockWindowRefresh
pub fn DockWindowRefresh() void {
    return fnPtrs.DockWindowRefresh();
}
...
pub fn EnumProjects(idx: c_int, projfnOutOptional: [*:0]u8, projfnOutOptional_sz: c_int) ?ReaProject {
...
pub fn EnumRegionRenderMatrix(proj: ?ReaProject, regionindex: c_int, rendertrack: c_int) ?MediaTrack {
...
pub fn Envelope_GetParentTake(env: ?TrackEnvelope, indexOutOptional: ?*c_int, index2OutOptional: ?*c_int) ?MediaItem_Take {
...
pub fn Envelope_GetParentTrack(env: ?TrackEnvelope, indexOutOptional: ?*c_int, index2OutOptional: ?*c_int) ?MediaTrack {
...
pub fn get_ini_file() [*:0]const u8 {
    return fnPtrs.get_ini_file();
}
...
pub fn GetActiveTake(item: ?MediaItem) ?MediaItem_Take {
...
pub fn GetAppVersion() [*:0]const u8 {
    return fnPtrs.GetAppVersion();
}
...
pub fn GetCurrentProjectInLoadSave() ?ReaProject {
    return fnPtrs.GetCurrentProjectInLoadSave();
}

/// GetCursorContext
/// return the current cursor context: 0 if track panels, 1 if items, 2 if envelopes, otherwise unknown
pub fn GetCursorContext() c_int {
    return fnPtrs.GetCursorContext();
}
...
pub fn GetCursorPosition() f64 {
    return fnPtrs.GetCursorPosition();
}
...
pub fn GetExePath() [*:0]const u8 {
    return fnPtrs.GetExePath();
}
...
pub fn GetFXEnvelope(track: ?MediaTrack, fxindex: c_int, parameterindex: c_int, create: bool) ?TrackEnvelope {
...
pub fn GetGlobalAutomationOverride() c_int {
    return fnPtrs.GetGlobalAutomationOverride();
}

/// GetHZoomLevel
/// returns pixels/second
pub fn GetHZoomLevel() f64 {
    return fnPtrs.GetHZoomLevel();
}
...
pub fn GetItemFromPoint(screen_x: c_int, screen_y: c_int, allow_locked: bool, takeOutOptional: ?MediaItem_Take) ?MediaItem {
    return fnPtrs.GetItemFromPoint(screen_x, screen_y, allow_locked, takeOutOptional);
}

/// GetItemProjectContext
pub fn GetItemProjectContext(item: ?MediaItem) ?ReaProject {
...
pub fn GetLastColorThemeFile() [*:0]const u8 {
    return fnPtrs.GetLastColorThemeFile();
}
...
/// GetLastTouchedTrack
pub fn GetLastTouchedTrack() ?MediaTrack {
    return fnPtrs.GetLastTouchedTrack();
}

/// GetMainHwnd
pub fn GetMainHwnd() HWND {
    return fnPtrs.GetMainHwnd();
}

/// GetMasterMuteSoloFlags
/// &1=master mute,&2=master solo. This is deprecated as you can just query the master track as well.
pub fn GetMasterMuteSoloFlags() c_int {
    return fnPtrs.GetMasterMuteSoloFlags();
}

/// GetMasterTrack
pub fn GetMasterTrack(proj: ?ReaProject) ?MediaTrack {
...
pub fn GetMasterTrackVisibility() c_int {
    return fnPtrs.GetMasterTrackVisibility();
}

/// GetMaxMidiInputs
/// returns max dev for midi inputs/outputs
pub fn GetMaxMidiInputs() c_int {
    return fnPtrs.GetMaxMidiInputs();
}

/// GetMaxMidiOutputs
pub fn GetMaxMidiOutputs() c_int {
    return fnPtrs.GetMaxMidiOutputs();
}
...
pub fn GetMediaItem(proj: ?ReaProject, itemidx: c_int) ?MediaItem {
    return fnPtrs.GetMediaItem(proj, itemidx);
}

/// GetMediaItem_Track
/// Get parent track of media item
pub fn GetMediaItem_Track(item: ?MediaItem) ?MediaTrack {
...
/// GetMediaItemTake
pub fn GetMediaItemTake(item: ?MediaItem, tk: c_int) ?MediaItem_Take {
    return fnPtrs.GetMediaItemTake(item, tk);
}

/// GetMediaItemTake_Item
/// Get parent item of media item take
pub fn GetMediaItemTake_Item(take: ?MediaItem_Take) ?MediaItem {
...
pub fn GetMediaItemTake_Source(take: ?MediaItem_Take) ?PCM_source {
    return fnPtrs.GetMediaItemTake_Source(take);
}

/// GetMediaItemTake_Track
/// Get parent track of media item take
pub fn GetMediaItemTake_Track(take: ?MediaItem_Take) ?MediaTrack {
    return fnPtrs.GetMediaItemTake_Track(take);
}

/// GetMediaItemTakeByGUID
pub fn GetMediaItemTakeByGUID(project: ?ReaProject, guid: ?GUID) ?MediaItem_Take {
...
/// GetMediaItemTrack
pub fn GetMediaItemTrack(item: ?MediaItem) ?MediaTrack {
...
pub fn GetMediaSourceParent(src: ?PCM_source) ?PCM_source {
...
pub fn GetMixerScroll() ?MediaTrack {
    return fnPtrs.GetMixerScroll();
}
...
pub fn GetNumAudioInputs() c_int {
    return fnPtrs.GetNumAudioInputs();
}

/// GetNumAudioOutputs
/// Return number of normal audio hardware outputs available
pub fn GetNumAudioOutputs() c_int {
    return fnPtrs.GetNumAudioOutputs();
}

/// GetNumMIDIInputs
/// returns max number of real midi hardware inputs
pub fn GetNumMIDIInputs() c_int {
    return fnPtrs.GetNumMIDIInputs();
}

/// GetNumMIDIOutputs
/// returns max number of real midi hardware outputs
pub fn GetNumMIDIOutputs() c_int {
    return fnPtrs.GetNumMIDIOutputs();
}
...
/// GetNumTracks
pub fn GetNumTracks() c_int {
    return fnPtrs.GetNumTracks();
}

/// GetOS
/// Returns "Win32", "Win64", "OSX32", "OSX64", "macOS-arm64", or "Other".
pub fn GetOS() [*:0]const u8 {
    return fnPtrs.GetOS();
}
...
pub fn GetOutputLatency() f64 {
    return fnPtrs.GetOutputLatency();
}

/// GetParentTrack
pub fn GetParentTrack(track: ?MediaTrack) ?MediaTrack {
...
pub fn GetPlayPosition() f64 {
    return fnPtrs.GetPlayPosition();
}

/// GetPlayPosition2
/// returns position of next audio block being processed
pub fn GetPlayPosition2() f64 {
    return fnPtrs.GetPlayPosition2();
}
...
pub fn GetPlayState() c_int {
    return fnPtrs.GetPlayState();
}
...
pub fn GetResourcePath() [*:0]const u8 {
    return fnPtrs.GetResourcePath();
}

/// GetSelectedEnvelope
/// get the currently selected envelope, returns NULL/nil if no envelope is selected
pub fn GetSelectedEnvelope(proj: ?ReaProject) ?TrackEnvelope {
...
pub fn GetSelectedMediaItem(proj: ?ReaProject, selitem: c_int) ?MediaItem {
...
pub fn GetSelectedTrack(proj: ?ReaProject, seltrackidx: c_int) ?MediaTrack {
...
pub fn GetSelectedTrack2(proj: ?ReaProject, seltrackidx: c_int, wantmaster: bool) ?MediaTrack {
...
pub fn GetSelectedTrackEnvelope(proj: ?ReaProject) ?TrackEnvelope {
...
pub fn GetSubProjectFromSource(src: ?PCM_source) ?ReaProject {
    return fnPtrs.GetSubProjectFromSource(src);
}

/// GetTake
/// get a take from an item by take count (zero-based)
pub fn GetTake(item: ?MediaItem, takeidx: c_int) ?MediaItem_Take {
    return fnPtrs.GetTake(item, takeidx);
}

/// GetTakeEnvelope
pub fn GetTakeEnvelope(take: ?MediaItem_Take, envidx: c_int) ?TrackEnvelope {
    return fnPtrs.GetTakeEnvelope(take, envidx);
}

/// GetTakeEnvelopeByName
pub fn GetTakeEnvelopeByName(take: ?MediaItem_Take, envname: [*:0]const u8) ?TrackEnvelope {
...
pub fn GetTooltipWindow() HWND {
    return fnPtrs.GetTooltipWindow();
}

/// GetTrack
/// get a track from a project by track count (zero-based) (proj=0 for active project)
pub fn GetTrack(proj: ?ReaProject, trackidx: c_int) ?MediaTrack {
...
/// GetTrackEnvelope
pub fn GetTrackEnvelope(track: ?MediaTrack, envidx: c_int) ?TrackEnvelope {
...
///
pub fn GetTrackEnvelopeByChunkName(tr: ?MediaTrack, cfgchunkname: [*:0]const u8) ?TrackEnvelope {
    return fnPtrs.GetTrackEnvelopeByChunkName(tr, cfgchunkname);
}

/// GetTrackEnvelopeByName
pub fn GetTrackEnvelopeByName(track: ?MediaTrack, envname: [*:0]const u8) ?TrackEnvelope {
...
pub fn GetTrackFromPoint(screen_x: c_int, screen_y: c_int, infoOutOptional: ?*c_int) ?MediaTrack {
    return fnPtrs.GetTrackFromPoint(screen_x, screen_y, infoOutOptional);
}

/// GetTrackGUID
pub fn GetTrackGUID(tr: ?MediaTrack) ?GUID {
...
/// GetTrackMediaItem
pub fn GetTrackMediaItem(tr: ?MediaTrack, itemidx: c_int) ?MediaItem {
...
pub fn guidToString(g: ?GUID, destNeed64: [*:0]u8) void {
...
pub fn IsInRealTimeAudio() c_int {
    return fnPtrs.IsInRealTimeAudio();
}
...
pub fn IsREAPER() bool {
    return fnPtrs.IsREAPER();
}
...
pub fn joystick_create(guid: ?GUID) ?joystick_device {
...
pub fn LICE_CreateBitmap(mode: c_int, w: c_int, h: c_int) ?LICE_IBitmap {
    return fnPtrs.LICE_CreateBitmap(mode, w, h);
}

/// LICE_CreateFont
pub fn LICE_CreateFont() ?LICE_IFont {
    return fnPtrs.LICE_CreateFont();
}
...
/// LICE_LoadPNG
pub fn LICE_LoadPNG(filename: [*:0]const u8, bmp: ?LICE_IBitmap) ?LICE_IBitmap {
    return fnPtrs.LICE_LoadPNG(filename, bmp);
}

/// LICE_LoadPNGFromResource
pub fn LICE_LoadPNGFromResource(hInst: HINSTANCE, resid: [*:0]const u8, bmp: ?LICE_IBitmap) ?LICE_IBitmap {
...
/// Master_GetTempo
pub fn Master_GetTempo() f64 {
    return fnPtrs.Master_GetTempo();
}
...
pub fn MIDI_eventlist_Create() ?MIDI_eventlist {
    return fnPtrs.MIDI_eventlist_Create();
}
...
pub fn midi_reinit() void {
    return fnPtrs.midi_reinit();
}
...
pub fn MIDIEditor_GetActive() HWND {
    return fnPtrs.MIDIEditor_GetActive();
}
...
pub fn MIDIEditor_GetTake(midieditor: HWND) ?MediaItem_Take {
...
/// my_getViewport
pub fn my_getViewport(r: ?RECT, sr: ?RECT, wantWorkArea: bool) void {
...
pub fn OnPauseButton() void {
    return fnPtrs.OnPauseButton();
}
...
pub fn OnPlayButton() void {
    return fnPtrs.OnPlayButton();
}
...
pub fn OnStopButton() void {
    return fnPtrs.OnStopButton();
}
...
/// PCM_Sink_Create
pub fn PCM_Sink_Create(filename: [*:0]const u8, cfg: [*:0]const u8, cfg_sz: c_int, nch: c_int, srate: c_int, buildpeaks: bool) ?PCM_sink {
    return fnPtrs.PCM_Sink_Create(filename, cfg, cfg_sz, nch, srate, buildpeaks);
}

/// PCM_Sink_CreateEx
pub fn PCM_Sink_CreateEx(proj: ?ReaProject, filename: [*:0]const u8, cfg: [*:0]const u8, cfg_sz: c_int, nch: c_int, srate: c_int, buildpeaks: bool) ?PCM_sink {
    return fnPtrs.PCM_Sink_CreateEx(proj, filename, cfg, cfg_sz, nch, srate, buildpeaks);
}

/// PCM_Sink_CreateMIDIFile
pub fn PCM_Sink_CreateMIDIFile(filename: [*:0]const u8, cfg: [*:0]const u8, cfg_sz: c_int, bpm: f64, div: c_int) ?PCM_sink {
    return fnPtrs.PCM_Sink_CreateMIDIFile(filename, cfg, cfg_sz, bpm, div);
}

/// PCM_Sink_CreateMIDIFileEx
pub fn PCM_Sink_CreateMIDIFileEx(proj: ?ReaProject, filename: [*:0]const u8, cfg: [*:0]const u8, cfg_sz: c_int, bpm: f64, div: c_int) ?PCM_sink {
...
pub fn PCM_Source_CreateFromFile(filename: [*:0]const u8) ?PCM_source {
...
pub fn PCM_Source_CreateFromFileEx(filename: [*:0]const u8, forcenoMidiImp: bool) ?PCM_source {
...
pub fn PCM_Source_CreateFromSimple(dec: ?ISimpleMediaDecoder, fnOut: [*:0]const u8) ?PCM_source {
...
pub fn PCM_Source_CreateFromType(sourcetype: [*:0]const u8) ?PCM_source {
...
/// PeakBuild_Create
pub fn PeakBuild_Create(src: ?PCM_source, fnOut: [*:0]const u8, srate: c_int, nch: c_int) ?REAPER_PeakBuild_Interface {
    return fnPtrs.PeakBuild_Create(src, fnOut, srate, nch);
}

/// PeakBuild_CreateEx
/// flags&1 for FP support
pub fn PeakBuild_CreateEx(src: ?PCM_source, fnOut: [*:0]const u8, srate: c_int, nch: c_int, flags: c_int) ?REAPER_PeakBuild_Interface {
    return fnPtrs.PeakBuild_CreateEx(src, fnOut, srate, nch, flags);
}

/// PeakGet_Create
pub fn PeakGet_Create(fnOut: [*:0]const u8, srate: c_int, nch: c_int) ?REAPER_PeakGet_Interface {
...
pub fn plugin_getFilterList() [*:0]const u8 {
    return fnPtrs.plugin_getFilterList();
}
...
pub fn plugin_getImportableProjectFilterList() [*:0]const u8 {
    return fnPtrs.plugin_getImportableProjectFilterList();
}
...
pub fn ReaperGetPitchShiftAPI(version: c_int) ?IReaperPitchShift {
...
/// Resampler_Create
pub fn Resampler_Create() ?REAPER_Resample_Interface {
    return fnPtrs.Resampler_Create();
}
...
/// SectionFromUniqueID
pub fn SectionFromUniqueID(uniqueID: c_int) ?KbdSectionInfo {
...
pub fn SetMixerScroll(leftmosttrack: ?MediaTrack) ?MediaTrack {
...
/// TakeFX_GetEnvelope
/// Returns the FX parameter envelope. If the envelope does not exist and create=true, the envelope will be created.
pub fn TakeFX_GetEnvelope(take: ?MediaItem_Take, fxindex: c_int, parameterindex: c_int, create: bool) ?TrackEnvelope {
...
/// TakeFX_GetFXGUID
pub fn TakeFX_GetFXGUID(take: ?MediaItem_Take, fx: c_int) ?GUID {
...
pub fn ThemeLayout_RefreshAll() void {
    return fnPtrs.ThemeLayout_RefreshAll();
}
...
pub fn time_precise() f64 {
    return fnPtrs.time_precise();
}
...
/// TrackFX_GetFXGUID
pub fn TrackFX_GetFXGUID(track: ?MediaTrack, fx: c_int) ?GUID {
...
pub fn TrackList_UpdateAllExternalSurfaces() void {
    return fnPtrs.TrackList_UpdateAllExternalSurfaces();
}

/// Undo_BeginBlock
/// call to start a new block
pub fn Undo_BeginBlock() void {
    return fnPtrs.Undo_BeginBlock();
}
...
pub fn UpdateArrange() void {
    return fnPtrs.UpdateArrange();
}
...
pub fn UpdateTimeline() void {
    return fnPtrs.UpdateTimeline();
}
